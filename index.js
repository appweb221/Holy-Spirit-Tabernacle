...
</div><div style="background-color: white; padding: 30px; border-radius: 30px 30px 0px 0px;"><h5>Kissimmee, Florida 34746</h5><br><br><h5>&#9993; snelson5412@gmail.com</h5><br><br><h5>&#9742; +1 407 508-1122
    </h5> <br><br><h5>Social Media:</h5><a href="https://www.facebook.com/charlie.inventory.7"><i class="fab fa-facebook fa-1x"
    style="color:rgb(71, 107, 185); width: 25px;"></i></a>
<a href="https://www.youtube.com/@holyspirittabernacle4701"><i class="fab fa-youtube fa-1x"
    style="color:rgb(231, 11, 11); width: 25px;"></i></a>
    <a href="https://wa.me/14075081122?text=I%20want%20to%20visit%20the%20church%20this%20Sunday."><i
              class="fab fa-whatsapp fa-1x" style="color:green"></i></a>
    </div>
    <div>
    <form style="text-align: center;">
            <fieldset>
                <legend style="text-align: center;">Select your status:</legend>
              
                <div>
                  <input type="radio" id="administration" name="drone" value="administration" checked />
                  <label for="administration" style="text-align: center;">Member</label>
                </div>
              
                <div>
                  <input type="radio" id="pedagogy" name="drone" value="pedagogy" />
                  <label for="pedagogy" style="text-align: center;">Visitor</label>
                </div>
        ...
        <br>
            ...
            <br>
            <input style="text-align: center; background-color: rgb(231, 226, 153);" type="phone"  name="phone" placeholder="700 000 1111" required>
        <br>
        <br>
        <label for="comment" style="text-align: center;"><b>Describe your request:</b></label>
        <br>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 60%; height: 100px;" id="comment" type="comment"  name="comment" placeholder="Describe your request in a few words..." required></textarea>
    <br>
    <br>
...
function churchContactF(){
  document.title = "Tabernacle du Saint-Esprit";
        ...
        </h5> <br><br><h5>Réseaux Sociaux:</h5><a href="https://www.facebook.com/charlie.inventory.7"><i class="fab fa-facebook fa-1x"
        style="color:rgb(71, 107, 185); width: 25px;"></i></a>
    <a href="https://www.youtube.com/@holyspirittabernacle4701"><i class="fab fa-youtube fa-1x"
        style="color:rgb(231, 11, 11); width: 25px;"></i></a>
        <a href="https://wa.me/14075081122?text=Mwen%20ta%20vle%20vizite%20legliz%20la%20Dimanch%20sa."><i
                  class="fab fa-whatsapp fa-1x" style="color:green"></i></a>
        </div>
        <div>
        <form style="text-align: center;">
            <fieldset>
                <legend style="text-align: center;">Choisir votre option:</legend>
              
                <div>
                  <input type="radio" id="administration" name="drone" value="administration" checked />
                  <label for="administration" style="text-align: center;">Membre</label>
                </div>
              
                <div>
                  <input type="radio" id="pedagogy" name="drone" value="pedagogy" />
                  <label for="pedagogy" style="text-align: center;">Visiteur</label>
                </div>
             
              
                <div>
                    <input type="radio" id="student" name="drone" value="student" />
                    <label for="student" style="text-align: center;">Autre</label>
                </div>
              </fieldset>
            <br>
            <label for="name" style="text-align: center;"><b>Prénom:</b></label>
            <br>
            <input style="text-align: center; background-color: rgb(235, 233, 162);" type="text" placeholder="Prénom" name="email" required>
        <br>
        <br>
            <label for="name" style="text-align: center;"><b>Nom:</b></label>
            <br>
            <input style="text-align: center; background-color: rgb(219, 224, 146);" type="text" placeholder="Nom" name="email" required>
        <br>
        <br>
            <label for="email" style="text-align: center;"><b>Email:   </b></label>
            <br>
        ...
        <br>
        <br>
        <label for="comment" style="text-align: center;"><b>Quelle est votre demande:</b></label>
        <br>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 60%; height: 100px;" id="comment" type="comment"  name="comment" placeholder="Describe your request in a few words..." required></textarea>
    <br>
    <br>
        ...
        <label>
            <input type="checkbox" checked="checked" name="remember">J'ai confirmé que toutes les informations sont vraies
          </label> 
            <button type="submit" style="background-color: rgb(168, 168, 121); font-weight: bold; color: white;">Envoyer</button>
        <br>
        <br>
        </form>
    </div>
...
function churchAbout(){
        ...
        <div style="background-image: url(crosses-that-open-bible-wooden-table_1150-17653.avif); border-radius: 30px 30px 0px 0px; padding: 15px 15px 0px 15px">
            ...
            <ul class="nav justify-content-center">
                ...
                <li class="nav-item">
                  <a class="nav-link" onclick="churchAbout()" style="cursor: pointer; background-color: aliceblue; border-radius: 30px;">About</a>
                </li>
                <li class="nav-item">
        ...
        </div><div style="background-color: white; padding: 30px; border-radius: 30px 30px 0px 0px;"><div>
        <h4 style="text-align: center;">
          <audio controls>
            <source src="English-HST.mp3" type="audio/mpeg">
            <source src="English-HST.ogg" type="audio/ogg">
          </audio>
        </h4>
      </div><h6>Holy Spirit Tabernacle</h6><p>H. S. T. is a church of the message in Orlando leaded by Pastor Strada Nelson. Jesus Christ is coming very soon to take the Spouse of Christ with him to heaven, for he said in John 14 that he would go to prepare a place for us and in the same John 14 he promised to send us the Holy Spirit as a helper. We, the Holy Spirit Tabernacle, we are a church of the message of the end time. We believe in the Lord Jesus as Christ; for anyone to have access to heaven, you must repent your sins, and receive baptism in the name of Jesus Christ. To understand the Bible from Genesis to the book of Revelation, you must have the Holy Spirit. We invite you to come to worship with us. Your life will not be the same because of the presence of the Holy Spirit among us.</p>
            </div>
            <div>
            <video
            style="width: 100%;"
            autoplay muted loop>
            <source src="churchbackgroundvideo.mp4" type="video/mp4">
          </video>
        </div>
        <div style="background-image: url(low-angle-view-cross-against-clear-blue-sky_1048944-29521241.avif);">
            <ul class="nav justify-content-center">
            ...
            <h4 style="text-align: center;">
              <audio controls>
                <source src="Français-TSE.mp3" type="audio/mpeg">
                <source src="Français-TSE.ogg" type="audio/ogg">
              </audio>
            </h4>
          </div><h6>Tabernacle du Saint-Esprit</h6><p>T. S. E. est une église du message à Orlando dirigée par le Pasteur Strada Nelson. Jésus-Christ vient très bientôt pour emmener l'Épouse du Christ avec lui au ciel, car il a dit dans Jean 14 qu'il irait nous préparer une place et dans le même Jean 14 il a promis de nous envoyer le Saint-Esprit comme aide. Nous, le Tabernacle du Saint-Esprit, nous sommes une église du message de la fin des temps. Nous croyons au Seigneur Jésus comme Christ ; pour que quiconque ait accès au ciel, vous devez vous repentir de vos péchés et recevoir le baptême au nom de Jésus-Christ. Pour comprendre la Bible, du livre de Genèse au livre d’Apocalypse, vous devez avoir le Saint-Esprit. Nous vous invitons à venir prier avec nous. Votre vie ne sera plus la même à cause de la présence du Saint-Esprit parmi nous.</p>
                </div>
                <div>
                <video
                style="width: 100%;"
...
<div>
    <div class="d-none d-lg-block" style="padding: 5px 0px 30px 0px; background-color: #a5fc04;">
        <h4
            style="text-align: center; font-weight: bold; font-family: fantasy; padding: 10px; margin: 0px; background-image: url(crosses-that-open-bible-wooden-table_1150-17653.avif); background-size: 200%; background-repeat: no-repeat;">
            Livres</h4>
        <div>
            <div class="row" style="margin: 10px; padding: 0px;">
                <div class="col-3" style="margin: 10px; padding: 0px;">
                    <a href="https://branham.fr/files/pdf/52/shp52-0816.pdf"
                        style="text-decoration: none;">
                        <div style="background-image: url(John-Baptizing-Jesus.jpg); background-size: 250%; background-repeat: no-repeat; height: 250px; font-family: 'Staatliches', cursive;
            margin: 10px;
            padding: 10px;
            ...
            width: 100%; border-radius: 30px;">
                ...
                <div class="col-4" style="margin: 10px; padding: 0px;">
                    <a href="https://branham.fr/files/pdf_print/63/shp63-1226.pdf"
                        style="text-decoration: none;">
                        <div style="background-image: url(churchb1.jpg); background-size: 100%; background-repeat: no-repeat; width: 100%; height: 250px; font-family: 'Staatliches', cursive;
          display: flex;
          flex-direction: column;
          ...
          justify-content: center;
          width: 100%; border-radius: 30px;">
                            <h5 style="text-align: center; background-color: #fcfcfc; border-radius: 30px; padding: 10px; border: 1px solid rgb(168, 159, 159);">L’ORDRE DE L’EGLISE.</h5>
                        </div>
                    </a>
                </div>
                <div class="col-4" style="margin: 10px; padding: 0px;">
                    <a href="http://www.cmpp.ch/serie3no11.pdf"
                        style="text-decoration: none;">
                        <div style="background-image: url(churchb3.jpg); background-size: 250%; background-repeat: no-repeat; width: 10%; height: 250px; font-family: 'Staatliches', cursive;
                    display: flex;
                    flex-direction: column;
        ...
        <div>
            ...
            width: 100%; border-radius: 30px;">
                ...
                <div class="col-4" style="margin: 10px; padding: 0px;">
                    <div class="col-12" style="margin: 10px; padding: 0px;">
                        <a href="https://branham.fr/files/books/expose.zip"
                            style="text-decoration: none;">
                            <div style="background-image: url(QA-Church-Age-Book-Cover.jpg); background-size: 300%; background-repeat: no-repeat; width: 100%; height: 250px; font-family: 'Staatliches', cursive;
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          width: 100%; border-radius: 30px;">
                                <h4 style="text-align: center;">Sept âges de l'Église</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col-12" style="margin: 10px; padding: 0px;">
                        <a href="https://branham.fr/files/books/SeptSceaux_fr.zip"
                            style="text-decoration: none;">
                            <div style="background-image: url(Branham1.jpeg); background-size: 350%; background-repeat: no-repeat; width: 100%; height: 250px; font-family: 'Staatliches', cursive;
                    display: flex;
                    flex-direction: column;
                    align-items: center;
                    justify-content: center;
        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row" style="margin: 0%; padding: 0px;">
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/47-0412.mp3" style="text-decoration: none;"><img
                                    src="abstract-cloud-azure-haze_23-2148102101.avif"
                                    style="width: 100%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(255, 255, 255); padding: 10px; background-image: url(abstract-cloud-azure-haze_23-2148102101.avif);">
                                    La Foi Est l'Assurance</h5>
                            </a>
                        </div>
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/49-1225.mp3" style="text-decoration: none;"><img
                                    src="fire-ice-concept-background-with-fog-godray-3d_115548-21.avif"
                                    style="width: 100%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(255, 255, 255); padding: 10px; background-image: url(fire-ice-concept-background-with-fog-godray-3d_115548-21.avif);">
                                    Divinité De Jésus-Christ</h5>
                            </a>
                        </div>
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/53-0403.mp3" style="text-decoration: none;"><img
                                    src="low-angle-view-cross-against-clear-blue-sky_1048944-29521241.avif"
                                    style="width: 100%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(255, 255, 255); padding: 10px; background-image: url(low-angle-view-cross-against-clear-blue-sky_1048944-29521241.avif);">
                                    La cruauté du péché</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row" style="margin: 0%; padding: 0px;">
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/54-1231.mp3"
                                style="text-decoration: none;"><img src="churchb4.jpg"
                                    style="width: 100%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(255, 255, 255); padding: 10px; background-image: url(churchb4.jpg);">
                        ...
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/58-0326.mp3"
                                style="text-decoration: none;"><img src="shining-blue-flow-background_1182-1836.avif"
                                    style="width: 100%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(3, 3, 3); padding: 10px; background-image: url(shining-blue-flow-background_1182-1836.avif);">
                                    Unis sous une seule tête</h5>
                            </a>
                        </div>
                        <div class="col-4" style="margin: 0px; padding: 0px;" style="text-decoration: none;">
                            <a href="https://branham.fr/mp3/60-0403.mp3" style="text-decoration: none;"><img
                                    src="low-angle-view-cross-against-clear-blue-sky_1048944-29521241.avif"
                                    style="width: 200%; height: 250px; ;">
                                <h5
                                    style="text-align: center; color: rgb(255, 255, 255); padding: 10px; background-image: url(low-angle-view-cross-against-clear-blue-sky_1048944-29521241.avif);">
                                    Les aigles de Dieu</h5>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row" style="margin: 0%; padding: 0px;">
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/60-0712.mp3" style="text-decoration: none;"><img
                                    src="John-Baptizing-Jesus.jpg" style="width: 300%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(3, 3, 3); padding: 10px; background-image: url(John-Baptizing-Jesus.jpg);">
                                    Ecoutez-le (adoption)</h5>
                            </a>
                        </div>
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/61-0216.mp3"
                                style="text-decoration: none;"><img
                                    src="picture of jesus christ before his ministry .webp"
                                    style="width: 900%; height: 250px;">
                                <h5
                        ...
                        <div class="col-4" style="margin: 0px; padding: 0px;">
                            <a href="https://branham.fr/mp3/62-0128M.mp3"
                                style="text-decoration: none;"><img src="Bible.jpg" style="width: 300%; height: 250px;">
                                <h5
                                    style="text-align: center; color: rgb(3, 3, 3); padding: 10px; background-image: url(Bible.jpg);">
                                    L'Incrédulité N'Arrête Pas Dieu</h5>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="row" style="margin: 0%; padding: 0px;">
                        <div class="col-6" style="margin: 0px; padding: 0px;">
                            <iframe style="width: 100%; height: 350px;"
                            src="https://www.youtube.com/embed/OnVNjjGV7gM?si=-zXgpiKSjMW_U4J5"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                        <div class="col-6" style="margin: 0px; padding: 0px;">
                            <iframe style="width: 100%; height: 350px;"
                            src="https://www.youtube.com/embed/MVf9KsZvz0o?si=353-hSQbeLLnhhdU" 
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
          ...
          <div class="carousel-item">
            ...
            <div class="row" style="margin: 0%; padding: 0px;">
                        <div class="col-6" style="margin: 0px; padding: 0px;">
                            <iframe style="width: 100%; height: 350px;"
                            src="https://www.youtube.com/embed/VouralXCSt8?si=2Adk6dVjgzaq3Wm3" 
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                        <div class="col-6" style="margin: 0px; padding: 0px;">
                            <iframe style="width: 100%; height: 350px;"
                            src="https://www.youtube.com/embed/c7MgLz8fmvI?si=_7n38wLslI-DWGCb"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
          ...
          <div class="carousel-item">
            ...
            <div class="row" style="margin: 0%; padding: 0px;">
                        <div class="col-6" style="margin: 0px; padding: 0px;">
                            <iframe style="width: 100%; height: 350px;"
                            src="https://www.youtube.com/embed/9si_w0yVJZs?si=9HNlBczBl_Pig8F6"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                        <div class="col-6" style="margin: 0px; padding: 0px;">
                            <iframe style="width: 100%; height: 350px;"
                            src="https://www.youtube.com/embed/VUVemAcYHso?si=Se90bABDUwhuGumz" 
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
